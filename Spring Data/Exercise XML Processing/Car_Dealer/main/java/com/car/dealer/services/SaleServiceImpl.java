...
import com.car.dealer.domain.dtos.views.salesWithDiscount.SalesModel;
...
public class SaleServiceImpl implements SaleService {
    ...
    private final int SALES_SEED_COUNT = 20;
    ...
    @Autowired
    public SaleServiceImpl(SaleRepository saleRepository, CarRepository carRepository, CustomerRepository customerRepository, ModelMapper modelMapper, Random random, JaxbUtil jaxbUtil) {
    ...
    @Override
    public void getSalesByDiscount() throws IOException, JAXBException {
        ...
        salesModel.setSales(salesByDiscount);
        this.jaxbUtil.saveToXML("sales-discounts", salesModel);
    }
}
